var app = (function () {
    ...
    const file$2 = "components/App.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = `Toke is ${/*urlToken*/ ctx[0]}`;
    			add_location(h1, file$2, 13, 4, 347);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	let t2;
    	let if_block_anchor;
    	let if_block = { urlToken: /*urlToken*/ ctx[0] } && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 10, 0, 295);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if ({ urlToken: /*urlToken*/ ctx[0] }) if_block.p(ctx, dirty);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("urlToken" in $$props) $$invalidate(0, urlToken = $$props.urlToken);
    	};
