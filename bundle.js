var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 35, 8, 1292);
    			attr_dev(header, "class", "header svelte-11ebzd6");
    			add_location(header, file, 34, 4, 1260);
    			add_location(button0, file, 38, 8, 1384);
    			add_location(button1, file, 39, 8, 1451);
    			attr_dev(div0, "class", "button svelte-11ebzd6");
    			add_location(div0, file, 37, 4, 1355);
    			attr_dev(textarea, "class", "source svelte-11ebzd6");
    			add_location(textarea, file, 43, 12, 1561);
    			attr_dev(div1, "class", "left-panel svelte-11ebzd6");
    			add_location(div1, file, 42, 8, 1524);
    			attr_dev(pre, "class", "output svelte-11ebzd6");
    			add_location(pre, file, 46, 12, 1677);
    			attr_dev(div2, "class", "right-panel svelte-11ebzd6");
    			add_location(div2, file, 45, 8, 1639);
    			attr_dev(div3, "class", "html-editor svelte-11ebzd6");
    			add_location(div3, file, 41, 4, 1490);
    			attr_dev(main, "class", "container svelte-11ebzd6");
    			add_location(main, file, 33, 0, 1231);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", generateToken, false, false, false),
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<JsonGenerator> was created with unknown prop '${key}'`);
    	});
    ...
    class JsonGenerator extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*urlCode*/ ctx[2] === undefined && !("urlCode" in props)) {
    			console.warn("<JsonGenerator> was created without expected prop 'urlCode'");
    		}
    	}
